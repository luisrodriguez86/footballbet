...
use Football\FootballbetBundle\Form\GroupType;
...
class GroupController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FootballbetBundle:Group')->findAll();

        return $this->render('FootballbetBundle:Group:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('FootballbetBundle:Group:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FootballbetBundle:Group')->find($id);
        ...
        return $this->render('FootballbetBundle:Group:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('FootballbetBundle:Group:edit.html.twig', array(
            'entity'      => $entity,
