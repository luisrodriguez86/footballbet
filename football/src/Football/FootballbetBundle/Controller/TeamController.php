...
use Football\FootballbetBundle\Form\TeamType;
...
class TeamController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FootballbetBundle:Team')->findAll();
        $paginator  = $this->get('knp_paginator');
        $pagination = $paginator->paginate(
            $entities,
            $this->getRequest()->get('page', 1),
            10 );
        return $this->render('FootballbetBundle:Team:index.html.twig', compact(
            'pagination'
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('FootballbetBundle:Team:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FootballbetBundle:Team')->find($id);
        ...
        return $this->render('FootballbetBundle:Team:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('FootballbetBundle:Team:edit.html.twig', array(
            'entity'      => $entity,
